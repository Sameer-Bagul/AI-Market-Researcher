      ...
      <Card>
        <CardContent className="p-8 space-y-6">
          <div className="p-4 bg-muted rounded-lg">
            <p>
              For the purpose of these Terms and Conditions, The term "we", "us", "our" used anywhere on this page shall mean our company, whose registered/operational office is <strong>2nd floor, Flat No. 8, Building D, S.No. 33/21, Wadgaon Budruk, Pune, Maharashtra, 411041</strong>. "you", "your", "user", "visitor" shall mean any natural or legal person who is visiting our website and/or agreed to purchase from us.
            </p>
          </div>

          <div className="space-y-6">
            <section>
              <h2 className="text-xl font-semibold mb-3">Your Use of the Website</h2>
              <p className="mb-3">
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3">Links and External Content</h2>
              <div className="space-y-4">
                <div className="border-l-4 border-primary pl-4">
                  <p>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3">Legal Jurisdiction</h2>
              <div className="space-y-4">
                <div className="border-l-4 border-primary pl-4">
                  <p>
